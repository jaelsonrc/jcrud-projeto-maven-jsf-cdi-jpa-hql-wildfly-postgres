...
@SequenceGenerator(name = "IMOVEL_SEQ_ID", sequenceName = "IMOVEL_SEQ_ID", allocationSize = 1)
public class Imovel extends AbstractEntity{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IMOVEL_SEQ_ID")
	private Long id;
